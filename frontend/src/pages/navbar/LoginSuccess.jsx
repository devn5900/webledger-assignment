...
<div role="status">
    <svg aria-hidden="true" class="w-10 h-10 mr-2 text-white animate-spin  fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span className='text-xl text-gray-700 font-bold'>Processing...</span>
    </div>
  )
}
